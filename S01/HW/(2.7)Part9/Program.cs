...
public class Program
    {
        ...
        public static int day_of_the_week(int year, int monthnum, int daynum)
        {
            int daysbefo= days_before_date(year, monthnum, daynum);
            int startday = 3;

            return (startday+ daysbefo) % 7;
        }
    }
}