...
class Program
{
    ...
    //chera private bekhater inke dakhel khode class darim sedash mizanim 
    ...
    static void Main8(string[] args)
    {
        ...
        string s = null;
        //s?.length in agar null bashe baghisho ejra nemikone 
        string name = s ?? "hassan";
        string name2 = s != null ? s : string.Empty;
        //string name = s??string.Empty ; in agar null nabod khodesh agar bod khali bezar 
        int r = 15;
